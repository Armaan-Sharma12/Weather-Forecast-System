...
def getWeather():
    ...
    photo1= ImageTk.PhotoImage(file=f"C:/code/weather forecast/icon/{firstdayimage}.png")
    ...
    img=(Image.open(f"C:/code/weather forecast/icon/{seconddayimage}.png"))
    ...
    img=(Image.open(f"C:/code/weather forecast/icon/{thirddayimage}.png"))
    resized_image=img.resize((50,50))
    ...
    img=(Image.open(f"C:/code/weather forecast/icon/{fourthdayimage}.png"))
    resized_image=img.resize((50,50))
    ...
    img=(Image.open(f"C:/code/weather forecast/icon/{fifthdayimage}.png"))
    resized_image=img.resize((50,50))
    ...
    img=(Image.open(f"C:/code/weather forecast/icon/{sixthdayimage}.png"))
    resized_image=img.resize((50,50))
    ...
    img=(Image.open(f"C:/code/weather forecast/icon/{seventhdayimage}.png"))
    resized_image=img.resize((50,50))
...
##icon
image_icon=PhotoImage(file="C:/code/weather forecast/Images/logo.png")
root.iconphoto(False,image_icon)

round_box=PhotoImage(file="C:/code/weather forecast/Images/Rounded Rectangle 1.png")
...
##search box
search_image=PhotoImage(file="C:/code/weather forecast/Images/Rounded Rectangle 3.png")
myimage=Label(image=search_image,bg="#57adff")
myimage.place(x=270,y=120)

weat_image=PhotoImage(file="C:/code/weather forecast/Images/Layer 7.png")
...
search_icon=PhotoImage(file="C:/code/weather forecast/Images/Layer 6.png")
...
##bottom boxes
firstbox=PhotoImage(file="C:/code/weather forecast/Images/Rounded Rectangle 2.png")
secondbox=PhotoImage(file="C:/code/weather forecast/Images/Rounded Rectangle 2 copy.png")
